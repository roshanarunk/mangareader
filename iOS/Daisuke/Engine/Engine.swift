...
final actor DaisukeEngine {
    ...
    init() {
        ...
        // Start VM
        let queue = DispatchQueue(label: "com.ceres.Mangareader.daisuke.jsc", attributes: .concurrent)
...
extension DaisukeEngine {
    private func downloadCommonsIfNecessary() async throws {
        let base = URL(string: "https://Mangareader.github.io/Common")!
